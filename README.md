...
```bash
curl -fsSLo linkmoth-v0.4.12-bootstrap.sh --proto '=https' --noproxy '*' --max-redirs 0 https://raw.githubusercontent.com/benukas/Linkmoth/v0.4.12/bootstrap.sh && sudo bash linkmoth-v0.4.12-bootstrap.sh
```

The bootstrap comes directly from the exact protected `v0.4.12` tag and refuses
redirects. It downloads the exact `v0.4.12` archive and its published
