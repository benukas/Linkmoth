...
```bash
curl -fsSLo linkmoth-v0.6.9-bootstrap.sh --proto '=https' --noproxy '*' --max-redirs 0 https://raw.githubusercontent.com/benukas/Linkmoth/v0.6.9/bootstrap.sh && sudo bash linkmoth-v0.6.9-bootstrap.sh
```

The bootstrap comes directly from the exact protected `v0.6.9` tag and refuses
redirects. It downloads the exact `v0.6.9` archive and its published
