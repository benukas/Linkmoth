...
```bash
curl -fsSLo linkmoth-v0.6.1-bootstrap.sh --proto '=https' --noproxy '*' --max-redirs 0 https://raw.githubusercontent.com/benukas/Linkmoth/v0.6.1/bootstrap.sh && sudo bash linkmoth-v0.6.1-bootstrap.sh
```

The bootstrap comes directly from the exact protected `v0.6.1` tag and refuses
redirects. It downloads the exact `v0.6.1` archive and its published
